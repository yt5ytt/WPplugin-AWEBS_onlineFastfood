...
class Enqueue
{
  ...
  public function load_awebs_admin_plugin_scripts(){
    wp_enqueue_style('awebs_admin_styles', AWEBS__PLUGIN_URL . 'includes/css/awebsAdmin.css');
  ...
  public function load_awebs_wp_plugin_scripts(){
    wp_enqueue_style('awebs_frontend_styles', AWEBS__PLUGIN_URL . 'includes/css/awebsFrontend.css');
